        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-6">
          {
            equipments.map((equipment, index) => (
              <Link href={`/equipment/${equipment.id}`} key={index}>
                <Card className="flex flex-col p-3 shadow-sm hover:shadow-md transition-shadow border-zinc-200 dark:border-zinc-800 rounded-xl" key={index}>
                  ...
                  <div className="flex flex-col gap-1 mb-3">
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <span className={`text-[10px] font-medium px-2 py-0.5 rounded flex-shrink-0 ${equipment.equipmentStatus === 'active'
                        ...
                        {equipment.equipmentStatus === 'active' ? 'Available' : equipment.equipmentStatus}
                      </span>
                    </div>
